...
int main(){
    ...
    std::cout << latches[28].after <<std::endl;
    std::cout << latches[29].after <<std::endl;
    ...
    std::cout << "output of IO " << latches[42].before << std::endl;
...
int build_arch()
{
    ...
    devices.push_back(new Register(*IO_buffer_in_2, *IO_buffer_out_2)); //rs, rd, control, output
